...
namespace PruebaFinal.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        public EmpresasController(PruebaFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Empresa != null ? 
                          ...
                          Problem("Entity set 'PruebaFinalContext.Empresa'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'PruebaFinalContext.Empresa'  is null.");
            }
            var empresa = await _context.Empresa.FindAsync(id);
            if (empresa != null)
            {
