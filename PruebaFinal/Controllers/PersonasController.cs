...
namespace PruebaFinal.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public PersonasController(PruebaFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Persona != null ? 
                          ...
                          Problem("Entity set 'PruebaFinalContext.Persona'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'PruebaFinalContext.Persona'  is null.");
            }
            var persona = await _context.Persona.FindAsync(id);
            if (persona != null)
            {
