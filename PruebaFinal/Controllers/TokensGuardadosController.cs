...
namespace PruebaFinal.Controllers
{
    public class TokensGuardadosController : Controller
    {
        ...
        public TokensGuardadosController(PruebaFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TokenGuardado != null ? 
                          ...
                          Problem("Entity set 'PruebaFinalContext.TokenGuardado'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'PruebaFinalContext.TokenGuardado'  is null.");
            }
            var tokenGuardado = await _context.TokenGuardado.FindAsync(id);
            if (tokenGuardado != null)
            {
