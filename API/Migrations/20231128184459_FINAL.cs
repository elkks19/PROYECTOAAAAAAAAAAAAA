        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    descProducto = table.Column<string>(type: "nvarchar(max)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalleWishlist", x => new { x.codWishlist, x.codProducto });
                    table.ForeignKey(
                        name: "FK_DetalleWishlist_Producto_codProducto",
                        column: x => x.codProducto,
                        principalTable: "Producto",
                        principalColumn: "codProducto",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetalleWishlist_Wishlist_codWishlist",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleWishlist_codProducto",
                table: "DetalleWishlist",
                column: "codProducto");
