...
<body>
    ...
    <img src="./RECURSOS/giff.gif" />

        <div name="login" id="formulario_login" runat="server">
            <div class="container">
                    <p>HOLA!</p>
                    ...
                    <span class="eye" onclick="myFunction()">
                        ...
                        <i style="color: #F0E6DA " id="hide2" class="fa-solid fa-eye-slash"></i>
                    </span>
                    ...
                    <div class="flex-row">
                        ...
                        <a style="text-decoration: none; color: #F0E6DA;font-size:11px" href="recuperar_contrasena.html">¿Olvidaste tu contraseña?</a>

                    </div>
                    <p style="font-size:13px;font-family:Hanken;padding-bottom:15px;padding-top:20px;">¿No tienes cuenta?<a style="padding-right:5px" href="../Preregistro/preregistro.html">Regístrate</a></p>

                        <button style="font-family: 'Genera-grotesk-heavy'; text-decoration: none; color: #FFFCED;  border: none;font-size:15px"
                           v-on:click="login" class="button">
                            Ingresa
...
.wrapper span {
    ...
    box-shadow: 0 0 50px #f6e477, 0 0 100px #2A2A2A, 0 0 150px rgba(0,0,0,0.2), 0 0 200px rgba(255,255,255,0.3);
...
form {
    ...
    padding: 3em;
    border-radius: 20px;
    background: rgba(285,286,256,0.3);
    backdrop-filter: blur(10px);
    box-shadow: 20px 20px 40px -6px rgba(0,0,0,0.2);
    text-align: center;
}
...
input {
    ...
    input[type="email"]:focus {
        box-shadow: 2px 2px 40px 5px #6E6B6B;
        outline: none;
    }
